    ...
    { Email: $("#Email").val() },
        function (data) {
            ...
            if (varVoucher == "0") {
                ...
                $("#divVoucher").html("<font color='red'>InValid</font>");
            }
            else {
                $("#hdnCode").val(VoucherObject)
                $("#divVoucher").html("<font color='green'>Check your email for voucher code</font>");
            }
        });
}
</script>
...
<script type="text/javascript">
    ...
    <h2>Create a New Account</h2>
        ...
        Use the form below to create a new account,<p style="font-size:medium;color:Olive"><b>  Enter your email id and press 'tab' a voucher code will be forwarded to your web mail.</b>. 
    </p>
    <p>
